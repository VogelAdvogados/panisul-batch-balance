...
export default function PurchasesPage() {
  ...
  const handlePurchaseSubmit = (
    purchaseData: TablesInsert<"purchases">,
    itemsData: Omit<TablesInsert<"purchase_items">, "purchase_id">[],
  ) => {
    createPurchaseMutation.mutate(
      { purchaseData, itemsData },
      {
        onSuccess: () => {
          toast({
            title: "Sucesso",
    ...
    updatePurchaseStatusMutation.mutate(
      { purchaseId, status: "confirmed" },
      {
        ...
        onError: (error) => {
          toast({
            title: "Erro",
            description: `Erro ao confirmar compra: ${error.message}`,
            variant: "destructive",
          })
        },
      },
  ...
  const renderTableContent = () => {
    ...
    return purchases?.map((purchase) => (
      <TableRow key={purchase.id}>
        ...
        <TableCell>
          R${" "}
          {purchase.total_amount.toLocaleString("pt-BR", {
        ...
        <TableCell>
          <div className="flex gap-2">
            ...
            {purchase.status === "pending" && (
              ...
              >
                {updatePurchaseStatusMutation.isPending &&
                updatePurchaseStatusMutation.variables?.purchaseId ===
                  purchase.id ? (
